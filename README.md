...
* **Gestión de Datos en Memoria:** Uso de estructuras de datos dinámicas mediante *Java Collections* (`ArrayList`) para la administración eficiente del catálogo de productos y el almacenamiento de los ítems en el carrito de compras.
* **Motor de Cálculos Financieros:** Programación de la lógica de negocio para el cálculo automático del total de la compra, incluyendo:
  * Aplicación de recargos financieros e impuestos según la cantidad de cuotas seleccionadas.
  * Cálculo de descuentos aplicables por pagos al contado.

## Ejecución Local
Al ser un proyecto nativo en Java, no requiere configuración de servidores ni bases de datos.
1. Clonar el repositorio.
2. Abrir el proyecto en cualquier IDE de Java (Eclipse, IntelliJ IDEA, VS Code).
3. Compilar y ejecutar la clase `Main` para iniciar la simulación por consola/interfaz.
